...
def venues():
    ...
    return render_template('pages/venues.html', areas=[data for data in data_set.values()]);
...
def show_venue(venue_id):
      ...
      return render_template('pages/show_venue.html', venue=venue_serializer(venue, False))
...
def edit_venue(venue_id):
      ...
      return render_template('forms/edit_venue.html', form=form, venue=serialized_data)
